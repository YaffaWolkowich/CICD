...
from project.send_alert_email import (
    ...
    main_alerts,
    creating_object_for_alerts_documentation_table,
)


@patch(
    "project.send_alert_email.get_connection_string_from_keyvalut",
    Mock(return_value=""),
)
@patch(
...
@patch(
    "project.send_alert_email.retrieve_data_from_table",
...
@patch(
    "project.send_alert_email.creating_object_for_alerts_documentation_table",
    Mock(
        return_value={
            "PartitionKey": "3",
            "RowKey": "3",
...
def test_creating_an_object_send_to_table():
    assert creating_object_for_alerts_documentation_table(
        1,
        1,
        "sender_date",
        "sub_name",
