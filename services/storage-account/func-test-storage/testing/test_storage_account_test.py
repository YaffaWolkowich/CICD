...
from project.storage_account_test import (
    create_object_for_documentation_table,
    check_alert,
...
@patch(
    ...
    Mock(return_value="create storage management client"),
)
@patch(
    "project.storage_account_test.find_resource_group_name",
    Mock(return_value="resource_group"),
)
@patch(
...
@patch(
    ...
    Mock(return_value={"alert": False, "last_fetch_time": "12-10-2023"}),
)
@patch(
    "project.storage_account_test.create_object_for_documentation_table",
...
def test_storage_account_test_assert_called_check_alert(check_alert):
    ...
    check_alert.assert_called_once_with(
        True, False, "storage_name", "5", 0, "subscription_name"
    )
...
@patch(
    "project.storage_account_test.check_last_fetch_is_early",
    Mock(return_value={"alert": True, "last_fetch_time": "12-10-2023"}),
)
@patch(
    "project.storage_account_test.create_object_for_documentation_table",
    Mock(return_value="entity"),
...
@patch("project.storage_account_test.create_object_for_documentation_table")
def test_storage_account_test_assert_called_create_object_for_documentation_table(
    create_object_for_documentation_table,
):
    storage_account_test(
        "storage_name",
    ...
    create_object_for_documentation_table.assert_called_once_with(
        "5",
        "0",
...
def test_storage_account_test_assert_called_check_last_fetch_is_early(
...
@patch("project.storage_account_test.upload_to_table", Mock(return_value=""))
@patch(
    "project.storage_account_test.check_alert",
    Mock(side_effect=Exception("check alert raise exception")),
)
...
def test_check_alert_with_alert_in_used_capacity(main_alerts):
    ...
    main_alerts.assert_called_once_with(
        "myfirsttrail",
        ":storage account myfirsttrail\nThe amount of storage in use has increased in the last 30 days",
        1,
        1,
        "subscription_name",
    )
...
def test_check_alert_with_alert_in_fetch_time(main_alerts):
    ...
    main_alerts.assert_called_once_with(
        "myfirsttrail",
        ":storage account myfirsttrail\nThe Storge has not been used for 30 days",
        1,
        1,
        "subscription_name",
    )
...
def test_check_alert_with_alert_in_used_capacity_and_in_fetch_time(main_alerts):
    ...
    main_alerts.assert_called_once_with(
        "myfirsttrail",
        ":storage account myfirsttrail\nThe amount of storage in use has increased in the last 30 days and The Storge has not been used for 30 days",
        1,
        1,
        "subscription_name",
    )
...
def test_create_object_for_documentation_table_return_type_dict():
    assert isinstance(
        str,
        type(
            type(
...
def test_create_object_for_documentation_table_return_str_value_for_partitionkey():
    assert isinstance(
        str,
        type(
            type(
...
def test_create_object_for_documentation_table_return_str_value_for_rowkey():
    assert isinstance(
        str,
        type(
            type(
...
def test_create_object_for_documentation_table_return_dict_with_len_12():
    assert (
        len(
            create_object_for_documentation_table(
                "1",
...
def test_create_object_for_documentation_table_when_last_storage_fetch_time_do_not_exist():
    assert (
        len(
            create_object_for_documentation_table(
                "1",
