...
@patch(
    "project.connect_to_azure.get_connection_string_from_keyvalut",
...
@patch("project.connect_to_azure.SecretClient", Mock(return_value=MockClient()))
@patch("project.connect_to_azure.keyvault_uri", "keyvault_uri")
@patch("project.connect_to_azure.secret_name", "secret_name")
def test_get_connection_string_from_keyvalut():
    assert get_connection_string_from_keyvalut("secret_name") == "value"
